...
public class TestMotorEncoderCommand extends CommandBase {
	 ...
	 */
	public TestMotorEncoderCommand(TestMotorSubsystem subsystem, double ticks) {
	...
	public void initialize() {
		testMotorSubsystem.drive(ticksToMove);
	}
	...
	public boolean isFinished() {
		return testMotorSubsystem.isAtReferencePosition();
	}
}
